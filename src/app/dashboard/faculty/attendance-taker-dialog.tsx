...
import { Loader2, Sparkles, QrCode, RefreshCw, XCircle, CheckCircle, Bluetooth, BluetoothConnected } from 'lucide-react';
      ...
      <div className="py-6 text-center space-y-6">
        ...
        {isSessionActive === 'bluetooth' && (
            <div className='flex flex-col items-center gap-4 text-muted-foreground h-40 justify-center'>
                ...
                <p className='text-sm'>Students can now connect via the "Bluetooth Check-in" card on their dashboard.</p>
            </div>
        )}
      </div>
